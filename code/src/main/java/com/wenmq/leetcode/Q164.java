...
public class Q164 {
    ...
    public static void main(String[] args) {
        ...
        int[] case1 = new int[]{3,6,9,1};
        int[] case2 = new int[]{1};
        System.out.println(solution.maximumGap(case1));
        System.out.println(solution.maximumGap(case2));
        System.out.println(solution.maximumGap2(case1));
        System.out.println(solution.maximumGap2(case2));
    }
