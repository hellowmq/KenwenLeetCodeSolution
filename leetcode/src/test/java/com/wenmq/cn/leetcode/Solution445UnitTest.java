...
import static com.wenmq.cn.leetcode.Solution445.ListNode;

public class Solution445UnitTest {

    private static final String TAG = "com.wenmq.cn.leetcode.Solution445";
    ...
    @Test
    public void coverageCase() {
        Assert.assertNull(mTestSolution.reverse(null));
    }
